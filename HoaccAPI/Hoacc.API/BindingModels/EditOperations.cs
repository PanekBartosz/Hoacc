...
public class EditOperations
{
    ...
    [Required] [Display(Name = "Type")] public string? Type { get; init; }

    [Required] [Display(Name = "Date")] public DateTime Date { get; init; }
    ...
    [Required] [Display(Name = "Amount")] public double Amount { get; init; }
