...
export const getOperationsFiltered = async (id: number, startDate: string, endDate: string): Promise<AxiosResponse> =>
 apiClient.get(`/Operations/user/${id}/filtered?startDate=${startDate}&endDate=${endDate}`)
